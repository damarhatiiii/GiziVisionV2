...
export default function QrCodeWidget() {
  ...
  const modalContent = isOpen && (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 animate-in fade-in duration-200">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-[325px] bg-[#121212] border border-[#262626] rounded-[24px] p-5 shadow-2xl z-10 text-center animate-in zoom-in-95 duration-200">
        ...
        {/* QR Code Frame */}
        <div className="bg-white rounded-[20px] p-4 w-[160px] h-[160px] mx-auto mb-4 flex items-center justify-center shadow-lg">
          {loading || !url ? (
